  ...
  return (
    <header className="p-4 flex justify-between">
      <Link to='/' className="flex items-center gap-1">
        ...
        <span className="text-lg font-bold">club travel</span>
      </Link>
      <div className="flex border border-gray-300 rounded-full py-2 px-4 gap-2 items-center shadow-md shadow-gray-300">
        <div>Anywhere</div>
